...
public class listaHoteles extends AppCompatActivity {
    ...
    public void crearLista(){
        ...
        listaHoteles.add(new MoldeHotel("Hotel2","2500000",R.drawable.hoteldostu));
        listaHoteles.add(new MoldeHotel("Hotel3","2500000",R.drawable.hoteltri));
        listaHoteles.add(new MoldeHotel("Hotel4","2500000",R.drawable.hotelcuatro));
        listaHoteles.add(new MoldeHotel("Hotel5","2500000",R.drawable.hotelcinco));
        listaHoteles.add(new MoldeHotel("Hotel6","2500000",R.drawable.hotelsix));
    }
}